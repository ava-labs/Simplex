...
// when an epoch change is indexed
// validator -> non-validator
// non-validator -> non-validator (without recreating a non-validator instance)
// validator -> validator
// non-validator -> validator

// when an epoch change is indexed(say epoch 2) but it is not the highest epoch we are aware of(epoch 10)
// non-validator -> non-validator
// validator -> non-validator (even if our node is validator in epoch 2)
// validator -> non-validator (even if our node is validator in epoch 10)
