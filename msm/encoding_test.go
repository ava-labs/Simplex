...
func TestICMEpochInfoEqual(t *testing.T) {
	tests := []struct {
		name     string
		a        *ICMEpochInfo
		b        *ICMEpochInfo
		...
		},
		{
			...
			a:    &ICMEpochInfo{EpochStartTime: 100, EpochNumber: 5, PChainEpochHeight: 200},
			b:    &ICMEpochInfo{EpochStartTime: 100, EpochNumber: 5, PChainEpochHeight: 200},
			expected: true,
		},
		{
			name: "different EpochStartTime",
			a:    &ICMEpochInfo{EpochStartTime: 100},
			b:    &ICMEpochInfo{EpochStartTime: 200},
			expected: false,
		},
		{
			name: "different EpochNumber",
			a:    &ICMEpochInfo{EpochNumber: 1},
			b:    &ICMEpochInfo{EpochNumber: 2},
			expected: false,
		},
		{
			name: "different PChainEpochHeight",
			a:    &ICMEpochInfo{PChainEpochHeight: 1},
			b:    &ICMEpochInfo{PChainEpochHeight: 2},
			expected: false,
		},
	}
